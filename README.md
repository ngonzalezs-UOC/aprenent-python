...
L'objectiu és la realització d'una pràctica que consolidi els coneixements apresos durant el semestre, prenent en consideració una temàtica i unes dades pròpies de la ciència de dades, i fent ús d'eines àmpliament emprades a dia d'avui com són PyCharm i Github.
